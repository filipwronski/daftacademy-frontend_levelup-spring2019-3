...
/*!***************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??ref--7-1!./node_modules/postcss-loader/src??ref--7-2!./node_modules/sass-loader/lib/loader.js??ref--7-3!./src/scss/main.scss ***!
  \***************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

eval("exports = module.exports = __webpack_require__(/*! ../../node_modules/css-loader/dist/runtime/api.js */ \"./node_modules/css-loader/dist/runtime/api.js\")(false);\n// Module\nexports.push([module.i, \".clock {\\n  display: flex;\\n  justify-content: center;\\n  align-items: center;\\n  height: 100vh; }\\n  .clock__value {\\n    color: red;\\n    font-size: 40px; }\\n\", \"\"]);\n\n\n\n//# sourceURL=webpack:///./src/scss/main.scss?./node_modules/css-loader/dist/cjs.js??ref--7-1!./node_modules/postcss-loader/src??ref--7-2!./node_modules/sass-loader/lib/loader.js??ref--7-3");
...
eval("var _marked =\n/*#__PURE__*/\nregeneratorRuntime.mark(timeGenerator);\n\nfunction timeGenerator(start) {\n  var initValue,\n      max,\n      time,\n      _args = arguments;\n  return regeneratorRuntime.wrap(function timeGenerator$(_context) {\n    while (1) {\n      switch (_context.prev = _context.next) {\n        case 0:\n          initValue = _args.length > 1 && _args[1] !== undefined ? _args[1] : 0;\n          max = _args.length > 2 && _args[2] !== undefined ? _args[2] : 60;\n          time = initValue;\n\n        case 3:\n          if (!(time < max)) {\n            _context.next = 9;\n            break;\n          }\n\n          _context.next = 6;\n          return time++;\n\n        case 6:\n          if (time === max) {\n            time = start;\n          }\n\n          _context.next = 3;\n          break;\n\n        case 9:\n        case \"end\":\n          return _context.stop();\n      }\n    }\n  }, _marked);\n}\n\nvar format = function format(val) {\n  return val.toString().padStart(2, '0');\n};\n\nvar renderClock = function renderClock(val) {\n  document.getElementById('clock').innerText = val;\n};\n\nvar startClock = function startClock() {\n  var second = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 55;\n  var minute = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 59;\n  var hour = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 11;\n  var secondGenerator = timeGenerator(0, second, 60);\n  var minuteGenerator = timeGenerator(0, minute, 60);\n  var hourGenerator = timeGenerator(1, hour, 13);\n  second = secondGenerator.next().value;\n  minute = minuteGenerator.next().value;\n  hour = hourGenerator.next().value;\n  setInterval(function () {\n    if (minute === 59 && second === 59) {\n      hour = hourGenerator.next().value;\n    }\n\n    if (second === 59) {\n      minute = minuteGenerator.next().value;\n    }\n\n    second = secondGenerator.next().value;\n    renderClock(\"\".concat(format(hour), \":\").concat(format(minute), \":\").concat(format(second)));\n  }, 1000);\n};\n\nvar getCurrentTime = function getCurrentTime() {\n  var now = new Date();\n  var hour = (now.getHours() + 24) % 12 || 12;\n  var minute = now.getMinutes();\n  var second = now.getSeconds();\n  return {\n    hour: hour,\n    minute: minute,\n    second: second\n  };\n};\n\nvar currentTime = getCurrentTime();\nstartClock(currentTime.second, currentTime.minute, currentTime.hour);\n\n//# sourceURL=webpack:///./src/script.js?");
...
eval("\nvar content = __webpack_require__(/*! !../../node_modules/css-loader/dist/cjs.js??ref--7-1!../../node_modules/postcss-loader/src??ref--7-2!../../node_modules/sass-loader/lib/loader.js??ref--7-3!./main.scss */ \"./node_modules/css-loader/dist/cjs.js?!./node_modules/postcss-loader/src/index.js?!./node_modules/sass-loader/lib/loader.js?!./src/scss/main.scss\");\n\nif(typeof content === 'string') content = [[module.i, content, '']];\n\nvar transform;\nvar insertInto;\n\n\n\nvar options = {\"sourceMap\":true,\"hmr\":true}\n\noptions.transform = transform\noptions.insertInto = undefined;\n\nvar update = __webpack_require__(/*! ../../node_modules/style-loader/lib/addStyles.js */ \"./node_modules/style-loader/lib/addStyles.js\")(content, options);\n\nif(content.locals) module.exports = content.locals;\n\nif(false) {}\n\n//# sourceURL=webpack:///./src/scss/main.scss?");
